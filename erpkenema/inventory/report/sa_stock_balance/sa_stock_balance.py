...
def execute(filters=None):
	columns, data = [], []
	columns = get_columns()
	sales_area_store = get_sales_area_store_data(filters)

	if not sales_area_store:
		frappe.msgprint('No records found')
		return columns, sales_area_store

	for d in sales_area_store:
		row = frappe._dict({
